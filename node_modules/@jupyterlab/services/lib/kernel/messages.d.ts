...
export declare namespace KernelMessage {
    ...
    type MessageContent<T extends Message = Message> = T['content'];
    /**
     ...
     * See [Comm open](https://jupyter-client.readthedocs.io/en/latest/messaging.html#opening-a-comm).
     */
    interface ICommOpenIOPubMsg extends IIOPubMessage<'comm_open'> {
        channel: 'iopub';
        content: ICommOpen;
    }
    /**
     ...
     * See [Comm open](https://jupyter-client.readthedocs.io/en/latest/messaging.html#opening-a-comm).
     */
    interface ICommOpenShellMsg extends IShellMessage<'comm_open'> {
        channel: 'shell';
        content: ICommOpen;
    }
    /**
     ...
     */
    function isCommOpenMsg(msg: IMessage): msg is ICommOpenIOPubMsg | ICommOpenShellMsg;
    type iopubshell = 'iopub' | 'shell';
    /**
     ...
     */
    function isCommMsgMsg(msg: IMessage): msg is ICommMsgMsg<'iopub' | 'shell'>;
    /**
     ...
     * **See also:** [[IHistoryReply]], [[[IKernel.history]]]
     */
    type IHistoryRequest = IHistoryRequestRange | IHistoryRequestTail | IHistoryRequestSearch;
    /**
