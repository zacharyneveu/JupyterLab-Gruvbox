 ...
 */
function m(e){var t=5381;var r=e.length;while(r--)t=t*33^e.charCodeAt(r);return(t>>>0).toString(36)}t.stringHash=m;/**
 * Transform a style string to a CSS string.
 */
function _(e,t){if(typeof t==="number"&&t!==0&&!h[e]){return e+":"+t+"px"}return e+":"+t}/**
 ...
 */
function b(e){return e.map(function(e){var t=e[0],r=e[1];if(!Array.isArray(r))return _(t,r);return r.map(function(e){return _(t,e)}).join(";")}).join(";")}/**
...
if(o&&s){var l=c.add(new C(o,c.hash,f?"u"+(++n).toString(36):undefined));i.push([s,l])}for(var d=0,p=u;d<p.length;d++){var y=p[d],v=y[0],g=y[1];h+=v+T(c,v,g,i,s)}}else{var m=s?x(t,s):t;if(o){var l=e.add(new C(o,e.hash,f?"u"+(++n).toString(36):undefined));i.push([m,l])}for(var _=0,S=u;_<S.length;_++){var b=S[_],v=b[0],g=b[1];h+=v+T(e,v,g,i,m)}}return h}/**
 * Register all styles, but collect for selector interpolation using the hash.
 */
function O(e,r,n,i,s){var a=new k(e.hash);var o=[];var u=T(a,r,n,o);var f="f"+a.hash(u);var h=s?s+"_"+f:f;for(var c=0,l=o;c<l.length;c++){var d=l[c],p=d[0],y=d[1];var v=i?x(p,"."+t.escape(h)):p;y.add(new R(v,y.hash,undefined,u))}return{cache:a,pid:u,id:h}}/**
 * Cache to list to styles.
 */
function I(e){var t="";for(var r=0;r<e.length;r++)t+=e[r];return t}/**
 * Noop changes.
 */
var j={add:function(){return undefined},change:function(){return undefined},remove:function(){return undefined}};/**
 * Implement a cache/event emitter.
 */
var k=/** @class */function(){function e(e,t){if(e===void 0){e=m}if(t===void 0){t=j}this.hash=e;this.changes=t;this.sheet=[];this.changeId=0;this._keys=[];this._children=Object.create(null);this._counters=Object.create(null)}e.prototype.add=function(t){var r=this._counters[t.id]||0;var n=this._children[t.id]||t.clone();this._counters[t.id]=r+1;if(r===0){this._children[n.id]=n;this._keys.push(n.id);this.sheet.push(n.getStyles());this.changeId++;this.changes.add(n,this._keys.length-1)}else{
 ...
 */
var A=/** @class */function(e){r(t,e);function t(t,r,n,i,s){if(r===void 0){r=""}if(i===void 0){i="a"+n(t+"."+r)}if(s===void 0){s=""}var a=e.call(this,n)||this;a.rule=t;a.style=r;a.hash=n;a.id=i;a.pid=s;return a}t.prototype.getStyles=function(){return this.rule+"{"+this.style+I(this.sheet)+"}"};t.prototype.getIdentifier=function(){return this.pid+"."+this.rule+"."+this.style};t.prototype.clone=function(){return new t(this.rule,this.style,this.hash,this.id,this.pid).merge(this)};return t}(k);t.Rule=A;/**
 * The FreeStyle class implements the API for everything else.
 */
var N=/** @class */function(i){r(s,i);function s(t,r,s,a){if(t===void 0){t=m}if(r===void 0){r=typeof e!=="undefined"&&e.env["NODE_ENV"]!=="production"}if(s===void 0){s="f"+(++n).toString(36)}var o=i.call(this,t,a)||this;o.hash=t;o.debug=r;o.id=s;return o}s.prototype.registerStyle=function(e,t){var r=this.debug?t:undefined;var n=O(this,"&",e,true,r),i=n.cache,s=n.id;this.merge(i);return s};s.prototype.registerKeyframes=function(e,t){return this.registerHashRule("@keyframes",e,t)};s.prototype.registerHashRule=function(e,r,n){var i=this.debug?n:undefined;var s=O(this,"",r,false,i),a=s.cache,o=s.pid,u=s.id;var f=new A(e+" "+t.escape(u),undefined,this.hash,undefined,o);this.add(f.merge(a));return u};s.prototype.registerRule=function(e,t){this.merge(O(this,e,t,false).cache)};s.prototype.registerCss=function(e){this.merge(O(this,"",e,false).cache)};s.prototype.getStyles=function(){return I(this.sheet)};s.prototype.getIdentifier=function(){return this.id};s.prototype.clone=function(){return new s(this.hash,this.debug,this.id,this.changes).merge(this)};return s}(k);t.FreeStyle=N;/**
